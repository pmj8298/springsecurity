...
---- 기존 회원가입과 로그인이 되면 세션이 살아있어서 자동로그인 된다
---- 그러므로 로그아웃(http://localhost:9090/logout)한 후 다시 로그인해야한다
INSERT INTO USERSJPA(email,password) VALUES('aaa@aaa.com','$2a$10$wCBX9ghQ2Dq5Vyk0Fl3/W.qUzoTG2tO7nECb0N.eigTe11.EcJhMq');
